package com.hustler.quote.ui.ColorPicker;
...
import static com.hustler.quote.ui.ColorPicker.QuotzyColorFOrmatHelper.assertColorValueInRange;
import static com.hustler.quote.ui.ColorPicker.QuotzyColorFOrmatHelper.formatColorValues;
...
public class QuotzyColorPicker extends Dialog implements SeekBar.OnSeekBarChangeListener {
     ...
     */
    public QuotzyColorPicker(Activity activity) {
        super(activity);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.quotzy_color_picker);
