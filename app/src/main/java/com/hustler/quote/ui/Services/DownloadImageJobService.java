            ...
            AppExecutor.getInstance().getNetworkExecutor().execute(new Runnable() {
                ...
                public void run() {
                    ...
                    try {
                        ...
                        ContentValues contentValues = FileUtils.storeAndGetImageMetaData(downloading_File);
...
//                                        getCropAndSetWallpaperIntent(FileProvider.getUriForFile(downloadImageJobService, "com.hustler.quote.fileprovider", (downloading_File))));
...
//                                downloadImageJobService.startActivity(intent);
                            ...
                            Intent intent_gallery = new Intent(Intent.ACTION_VIEW, FileProvider.getUriForFile(downloadImageJobService, "com.hustler.quote.fileprovider", (downloading_File)));
