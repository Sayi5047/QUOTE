...
//        parallaxViewsPagerTransformer.setBorder(2);
//        parallaxViewsPagerTransformer.setSpeed(0.2f);

        viewPager.setPageTransformer(false, parallaxViewsPagerTransformer);
...
//                skip.setBackgroundColor(currentcolor);
    ...
    private class landerAdapter extends FragmentStatePagerAdapter {
        ...
        public landerAdapter(FragmentManager fm, Context context) {
            super(fm);
