...
public class WallpaperAdapter extends RecyclerView.Adapter<WallpaperAdapter.WallpaperViewholder> {
    ...
    @NonNull
    private static ArrayList<Unsplash_Image> m_AL_Images = new ArrayList<>();
    private Unsplash_Image[] images;
    private OnWallpaperClickListener onimageClickListener;
    ...
    private int from_which_activity;
