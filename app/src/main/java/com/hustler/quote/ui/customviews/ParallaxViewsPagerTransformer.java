...
public class ParallaxViewsPagerTransformer implements ViewPager.PageTransformer {
    private final int id2, id3, id4, id5;
    int id;
    private int border = 0;
    private float speed = 0.2f;

    public ParallaxViewsPagerTransformer(int id, int id2, int id3, int id4, int id5) {
        this.id = id;
        this.id2 = id2;
        this.id3 = id3;
        this.id4 = id4;
