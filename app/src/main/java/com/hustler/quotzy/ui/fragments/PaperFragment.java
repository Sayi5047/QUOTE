...
public class PaperFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        com.hustler.quotzy.ui.utils.TextUtils.findText_and_applyTypeface(radioGroup, getActivity());
        com.hustler.quotzy.ui.utils.TextUtils.findText_and_applyTypeface(loading_layout, getActivity());
