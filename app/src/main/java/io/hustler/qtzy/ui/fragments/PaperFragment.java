...
public class PaperFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        io.hustler.qtzy.ui.utils.TextUtils.findText_and_applyTypeface(radioGroup, getActivity());
        io.hustler.qtzy.ui.utils.TextUtils.findText_and_applyTypeface(loading_layout, getActivity());
